...
namespace Assets.Scripts.Util
{
    ...
    public class Constants
    {
        ...
        /**
         * Diese Methode speichert den Abschuss eines Spielers in seiner csv-Datei.
         */
        ...
        /**
         * Diese Methode startet das PathViewerSystem mittels eines Process. Der Parameter 'window' gibt an, ob das Command-Fenster beim Start sichtbar oder unsichtbar ist.
         */
        public static void StartPathViewerServer(bool window)
        {
            proc = new Process();
            proc.StartInfo.UseShellExecute = false;
            proc.StartInfo.FileName = "java";
            proc.StartInfo.Arguments = "-jar " + "PathViewer.jar" + " " + 5558;
            if (!window)
            {
                proc.StartInfo.RedirectStandardError = true;
                proc.StartInfo.RedirectStandardOutput = true;
