...
{
    /// <summary>
    /// Takes snapshot images of prefabs and GameObject instances, and provides methods to save them
    /// as PNG files.
    /// </summary>
    public class SnapshotCamera : MonoBehaviour
    {
        // This disables the "never assigned" warning. These fields will be assigned by the factory.
        ...
        /// <param name="name">
        /// The name that will be given to the new GameObject the SnapshotCamera will be attached to.
        /// </param>
        ...
        /// <param name="filename">
        /// The name of the file. This will be the current timestamp if not specified.
        /// </param>
        /// <param name="directory">
        /// The directory in which to save the file. This will be the game/Snapshots directory if
        /// not specified.
        /// </param>
        ...
        #endregion PNG saving

        #region Object preparation

        /// <summary>
        /// Prepares an instantiated GameObject for taking a snapshot by setting its layers and
        /// applying the specified position offset, rotation, and scale to it.
        /// </summary>
        /// <param name="prefab">The instantiated GameObject to prepare.</param>
        /// <param name="positionOffset">
        /// The position offset relative to the SnapshotCamera to apply to the gameObject.
        /// </param>
        ...
        /// <returns>
        /// A GameObjectStateSnapshot containing the state of the gameObject prior to modifying its
        /// layers, position, rotation, and scale.
        /// </returns>
        ...
        /// <summary>
        /// Prepares a prefab for taking a snapshot by creating an instance, setting its layers and
        /// applying the specified position offset, rotation, and scale to it.
        /// </summary>
        /// <param name="prefab">The prefab to prepare.</param>
        /// <param name="positionOffset">
        /// The position offset relative to the SnapshotCamera to apply to the prefab.
        /// </param>
        ...
        /// <summary>
        /// Set the layers of the GameObject and all its children to the SnapshotCamera's snapshot
        /// layer so the SnapshotCamera can see it.
        /// </summary>
        ...
        /// <summary>
        /// This stores the a state (layers, position, rotation, and scale) of a GameObject, and
        ...
        ///
        /// Uses a completely transparent background and applies the default position offset,
        /// rotation and scale to the gameObject while taking the snapshot, and restores them afterwards.
        /// </summary>
        ...
        /// Takes a snapshot of an instantiated GameObject and returns it as a Texture2D.
        ///
        /// Applies the default position offset, rotation and scale to the gameObject while taking
        /// the snapshot, and restores them afterwards.
        /// </summary>
        /// <param name="gameObject">The instantiated GameObject to snapshot.</param>
        ...
        /// <param name="gameObject">The instantiated GameObject to snapshot.</param>
        /// <param name="positionOffset">
        /// The position offset relative to the SnapshotCamera that will be applied to the
        /// gameObject while taking the snapshot. Its position will be restored after taking the snapshot.
        /// </param>
        /// <param name="rotation">
        /// The rotation that will be applied to the gameObject while taking the snapshot. Its
        /// rotation will be restored after taking the snapshot.
        /// </param>
        /// <param name="scale">
        /// The scale that will be applied to the gameObject while taking the snapshot. Its scale
        /// will be restored after taking the snapshot.
        /// </param>
        /// <param name="width">The width of the snapshot image.</param>
        /// <param name="height">The height of the snapshot image.</param>
        /// <returns>A Texture2D containing the captured snapshot.</returns>
        ...
        ///
        /// Uses a completely transparent background and applies the default position offset,
        /// rotation and scale to the prefab while taking the snapshot.
        /// </summary>
        ...
        /// <param name="prefab">The prefab to snapshot.</param>
        /// <param name="positionOffset">
        /// The position offset relative to the SnapshotCamera that will be applied to the prefab
        /// while taking the snapshot.
        /// </param>
        /// <param name="rotation">
        /// The rotation that will be applied to the prefab while taking the snapshot.
        /// </param>
        ...
        #endregion TakePrefabSnapshot

        /// <summary>
        /// Takes a snapshot of whatever is in front of the camera and within the camera's culling
        /// mask and returns it as a Texture2D.
        /// </summary>
        /// <param name="backgroundColor">
        /// The background color to apply to the camera before taking the snapshot.
        /// </param>
        /// <param name="width">The width of the snapshot image.</param>
        /// <param name="height">The height of the snapshot image.</param>
        /// <returns>A Texture2D containing the captured snapshot.</returns>
        private Texture2D TakeSnapshot(Color backgroundColor, int width, int height)
        {
            ...
            // TODO: Can we render a gameobject somehow?
            cam.Render();
            ...
            // TODO: Cant we just take the topLeft Point here?
