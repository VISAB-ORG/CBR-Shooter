...
{
    /// <summary>
    /// Helper class for running asynchronous methods synchronously without deadlocking the current thread.
    /// Should be used when VISABApi should be used in non async methods.
    /// </summary>
